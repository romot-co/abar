...
_ERROR_CODES = {
    ...
    "another Session is active": "session_already_active",
    ...
    "skipped Delivery cannot be answered": "delivery_already_skipped",
    "observation variants must differ": "observation_same_variant",
